...
* **prior_work** corresponds to Section 3.1 of the published paper (Appendix E of the extended version).

* **preliminary_experiment** corresponds to Section 3.2 of the published paper (Experiment 1 in the extended version).

* **main_experiment** corresponds to the main experiment described in the published paper (Experiment 2 in the extended version).
